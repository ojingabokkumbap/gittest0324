...
function jusorokView() {
	...
	function couponSelected(e) {
	  const text = e.options[e.selectedIndex].text;
	  const valText = e.options[e.selectedIndex].value;
	  const valTextArr = valText.split("/");
	  console.log(e.options);
	  document.getElementById('coupon').innerText  = text;
	  totalPrice(valText.split("/")[1],valText.split("/")[2],valText.split("/")[3]);
	}

	function totalPrice(orderTotalPrice,baesong,coupon) {
		let totalPrice = parseInt(orderTotalPrice) + parseInt(baesong) - parseInt(coupon);
    ...
    <div class='order-info'>
      <div class='order-info-content'>
       ...
       <div style='float:right; text-align:right;'>
         ...
         <b><input type="text" name="totalPrice" id="totalPrice" style="text-align:right;border:0px;" readonly /></b>원
       </div>
		</div>
       <br><br><br><br>
</div>
	          ...
	          전화번호
					...
					<div class="input-group mb-3">
		  			...
		  			쿠폰&nbsp;
							<div class="input-group mb-1">
								<div class="input-group-append">
								<select class="form-control" onchange="couponSelected(this)" style=" width: 350px;">
									<option value="">쿠폰을 선택하세요.</option>
						        <c:forEach var="couponDownVo" items="${couponDownVo}">
						        	<option value="${couponDownVo.idx}/${orderTotalPrice}/${sOrderVos[0].baesong}/${couponDownVo.CPrice}">${couponDownVo.CName}(-<fmt:formatNumber value="${couponDownVo.CPrice}"/>원)</option>
						        </c:forEach>
				        </select>
								</div>
							</div>			  			
