...
<div class="wrapper">
    ...
    <section>
    	<div class="container" >
    		<div class="" style="float:left;background-color: #211e1f;left: 10%;margin-left: -1.35%;width: 45%;height:437px;color: white; padding:65px;">
    			<h2><b>정보 찾기</b></h2>
    			<p><b>등록하신 정보를 통해 아이디를 찾을 수 있습니다.</b></p>
	    		</div>
	    			<form name="myform" method="post" class="was-validated">
	    				<div style="float: right; width:50%; padding-top:40px;" >
			    			...
			    			<div class="invalid-feedback">등록하신 이메일을 입력하세요.</div>
			    			<br><br><br>
			    			<button type="button" class="btn btn-primary" onclick="fCheck()" style="margin-left:235px;">찾 기</button> &nbsp;
	    			</div>
